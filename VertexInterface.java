...
public interface VertexInterface<T> {
	...
	points toward a given vertex.
	@param endVertex A vertex in the graph that ends the edge.
	@param endWeight A real-valued edge weight, if any.
	@return True if the edge is added and false if not. */
	public boolean connect(VertexInterface<T> endVertex, double edgeWeight);

	/** Connects this vertex and a given vertex with a unweighted edge.
	The two vertices cannot be the same, and must not already 
	have this edge between them. In a directed graph, the edge
	points toward a given vertex.
	@param endVertex A vertex in the graph that ends the edge.
	...
	/** Disconnects this vertex and a given vertex with a unweighted edge.
	In a directed graph, the edge points toward a given vertex.
	@param endVertex A vertex in the graph that ends the edge.
	...
	/** Gets the recorded predecessor of this vertex of this vertex.
